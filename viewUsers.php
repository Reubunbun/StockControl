    ...
    <header class="mainNav">
      <nav>
        <ul>
          ...
          <?php
            if ($userType === "admin") {
              echo "<li class='visiting'><a href='viewUsers.php'><div><p>View Users</p></div></a></li>";
            }
          ?>
    ...
    <main>
      <section class="editContainer">
        ...
        <div class="userButtons">
          <div>
            <input type="submit" value="Change Type" disabled="disabled" id="btn1" onclick="changeType()"/>
            <div>
              <input type="radio" name="userType" id="pendingCheck" /><span>Pending</span><br />
              <input type="radio" name="userType" checked="checked" id="userCheck" /><span>User</span><br />
              <input type="radio" name="userType" id="adminCheck" /><span>Admin</span><br />
            </div>
          </div>
